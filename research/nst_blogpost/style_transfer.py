...
content_path = './dataset/Green_Sea_Turtle_grazing_seagrass.jpg'
style_path = './dataset/The_Great_Wave_off_Kanagawa.jpg'
...
def run_style_transfer(content_path, style_path, num_iterations=1000, content_weight=1e3, style_weight=1e-2):
    ...
    cfg = {'model': model, 'loss_weights': loss_weights, 'init_image': init_image,
        'gram_style_features': gram_style_features, 'content_features': content_features}
...
best_starry_night, best_loss = run_style_transfer('./dataset/Tuebingen_Neckarfront.jpg',
                                                  './dataset/1024px-Van_Gogh_-_Starry_Night_-_Google_Art_Project.jpg')

# In[ ]:

show_results(best_starry_night, './dataset/Tuebingen_Neckarfront.jpg',
             './dataset/1024px-Van_Gogh_-_Starry_Night_-_Google_Art_Project.jpg')
...
best_poc_tubingen, best_loss = run_style_transfer('./dataset/Tuebingen_Neckarfront.jpg',
                                                  './dataset/Pillars_of_creation_2014_HST_WFC3-UVIS_full-res_denoised.jpg')

# In[ ]:

show_results(best_poc_tubingen, './dataset/Tuebingen_Neckarfront.jpg',
             './dataset/Pillars_of_creation_2014_HST_WFC3-UVIS_full-res_denoised.jpg')
...
best_kandinsky_tubingen, best_loss = run_style_transfer('./dataset/Tuebingen_Neckarfront.jpg',
                                                        './dataset/Vassily_Kandinsky,_1913_-_Composition_7.jpg')

# In[ ]:

show_results(best_kandinsky_tubingen, './dataset/Tuebingen_Neckarfront.jpg',
             './dataset/Vassily_Kandinsky,_1913_-_Composition_7.jpg')
...
best_poc_turtle, best_loss = run_style_transfer('./dataset/Green_Sea_Turtle_grazing_seagrass.jpg',
                                                './dataset/Pillars_of_creation_2014_HST_WFC3-UVIS_full-res_denoised.jpg')

# In[ ]:

show_results(best_poc_turtle, './dataset/Green_Sea_Turtle_grazing_seagrass.jpg',
             './dataset/Pillars_of_creation_2014_HST_WFC3-UVIS_full-res_denoised.jpg')
